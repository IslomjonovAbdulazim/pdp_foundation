...
class _StudyApiClient implements StudyApiClient {
  _StudyApiClient(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'http://176.57.214.64:8020/';
  }
  ...
  Future<List<ThemeModel>> getThemes(String token) async {
    ...
    try {
      _value = _result.data!
          .map(
            (dynamic i) => ThemeModel.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
  ...
  Future<List<TopicModel>> getTopics(int themeId, String token) async {
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<TopicModel> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => TopicModel.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  Future<List<DocumentModel>> getDocument(int documentID, String token) async {
    ...
    final _options = _setStreamType<List<DocumentModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/get-document/${documentID}/',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<DocumentModel> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => DocumentModel.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  Future<QuizResultResponseModel> quizResult(
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = login;
    final _options = _setStreamType<QuizResultResponseModel>(
